/*
  Author:  Modified Exercise 27 - 02 by Chad Lister.
  Date: 08/27/2020
  ...
  Download these files to start. Exercise 27_02 implements MyMap using quadratic probing. Modify this to use double hashing for open addressing. Edit get, put, and remove.
*/
...
//      int k = hash(key.hashCode());
      int k = (Integer) key % table.length;
...
//        i = 11 - key % 11;
        i = (11 - (Integer) key % 11) % table.length;
        j++;
      }
