public class Exercise28_07 {
	public static void main(String[] args) {
		...
		//  Edge 2, 3 comes before 2, 4 (2nd line in Edges) while 3, "Denver",  hasn't been visited so why would it go to 4, "Kansas City", then 3,  "Denver", during cycle build.
		...
		//  This graph gives errors on cycle build so uses a tree build.
		...
		System.out.println("Find a cycle " + graph1.getACycle2());
	}
}