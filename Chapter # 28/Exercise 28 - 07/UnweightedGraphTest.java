...
//    int vv = vn.v;
    ...
    System.out.println(". Path. " + d.getPath(end / 2));
    while (end != 0) {
      V vert = pathList.get(0);
      int i = getIndex(vert);
      pList.add(i);
      pathList.remove(0);
      end--;
...
//    System.out.println("  path  " + d.getPath(3) + "  Parent 2  " + d.getParent(2) +  "  Parent 3  " + d.getParent(3));
    return pList;
  }
...
//    System.out.println(". Vlist 0. " + vList.get(0) + "  vList 5. " + vList.get(4));
//    
//    while(!vList.isEmpty()) {
////      V v = getVertex(0);
//      V v = vList.get(0);
...
//              
//              V cc = vList.get(e.v);
//              System.out.println("  V " + vList.get(e.v) +  "  U Par of V. " + vList.get(e.u) + "  stack. " + stack.peek());
//              stack.push(cc);
////              stack.push(b);
//              isVisited[c] = true;
//              vList.remove(cc);       
////              vList.remove(b);
//              getNeighbors(x).remove(i);
// //             z++;
////              if (z == 3)
////                break;
//              break;
...
////              List<Integer> countC = new ArrayList<>();
//              countC.add(c);
//              System.out.println(". **. Here  **. " + c + "  count c. " + countC.get(0));
//              while(x != c && x != -1) {
//                System.out.print(". * S * " + x + "  count c  " + countC.get(0));
//                countC.add(x);
//                System.out.println(". After  add. " + countC.get(0));
//                parent[x] = x;
//                
//                z++;
//                if (z == 13)
