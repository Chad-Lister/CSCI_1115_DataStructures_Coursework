...
//  Added by Chad Lister.
    System.out.println("  ***  When it gets to San Francisco the output example says it should go to Denver instead of Los Angeles when the EDGES are defined ( Seatle, Los Angeles, Denver ) which doesn't make sense to me.");
    System.out.println();
