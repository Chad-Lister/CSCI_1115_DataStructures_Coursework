...
public class Exercise_20_03 {
  public static void main(String[] args) {
    ...
    // Declare a list as the Array.
    List<String[]> randomCapital = Arrays.asList(stateCapital);
    
    //  Shuffle.
    Collections.shuffle(randomCapital);
    
    //  Copy shuffled list to new Array.
    stateCapital = randomCapital.toArray(new String[0][0]);
