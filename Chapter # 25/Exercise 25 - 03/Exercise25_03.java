/*
  Author:  Exercise 25_03 modified by Chad Lister
  Date: 08/23/2020
...
import java.util.*;              //  Added by Chad Lister.
import java.util.Scanner;

public class Exercise25_03 {
  public static void main(String[] args) {
//    BST<Integer> treeI = new BST<Integer>();
...
//    treeI.inorder();
  ...
  public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void nonRecursiveInorder() {
      ...
      //  Add root to current.  If root is empty exit.
      if (root != null) {
        current = root;
      }
      else {
      ...
      while (!treeStack.empty() || current != null) {
        ...
        //  If current node is not null, push it to the stack and move to left child.
        if (current != null) {
          ...
          //  Else if current node is null, we pop an element from the stack, print it and move to right child.
